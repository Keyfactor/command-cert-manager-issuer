...
//+kubebuilder:rbac:groups=command-issuer.keyfactor.com,resources=clusterissuers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=command-issuer.keyfactor.com,resources=clusterissuers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=command-issuer.keyfactor.com,resources=clusterissuers/finalizers,verbs=update
...
func (r *ClusterIssuerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&commandissuerv1alpha1.ClusterIssuer{}).
		Complete(r)
}
