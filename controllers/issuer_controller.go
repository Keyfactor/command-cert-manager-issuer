...
//+kubebuilder:rbac:groups=command-issuer.keyfactor.com,resources=issuers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=command-issuer.keyfactor.com,resources=issuers/status,verbs=get;update;patch
...
func (r *IssuerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&commandissuerv1alpha1.Issuer{}).
		Complete(r)
}
